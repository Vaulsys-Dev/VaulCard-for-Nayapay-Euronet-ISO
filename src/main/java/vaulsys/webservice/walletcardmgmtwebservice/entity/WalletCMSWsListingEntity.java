...
//    }
    ...
    public WalletCMSWsListingEntity copy(WalletCMSWsEntity cmsWsEntity) {
        ...
        this.setIsinternational(cmsWsEntity.getIsinternational());
        this.setAcqreferenceno(cmsWsEntity.getAcqreferenceno());
        this.setCentralprocessingdate(cmsWsEntity.getCentralprocessingdate());
        this.setSchemetransactionid(cmsWsEntity.getSchemetransactionid());
        this.setSourceamount(cmsWsEntity.getSourceamount());
        this.setSourcecurrency(cmsWsEntity.getSourcecurrency());
        // ==========================================================
        ...
        this.setIntltxnfee(cmsWsEntity.getIntltxnfee());
        this.setIntltxnfeetax(cmsWsEntity.getIntltxnfeetax());
        this.setIntltxnfeeinusd(cmsWsEntity.getIntltxnfeeinusd());
        this.setDccflag(cmsWsEntity.getDccflag());
        this.setNayapayrevenuebuffer(cmsWsEntity.getNayapayrevenuebuffer());
        this.setNayapayinterbankusdrate(cmsWsEntity.getNayapayinterbankusdrate());
        this.setSettbankspread(cmsWsEntity.getSettbankspread());
        // ==================================================================

        // Asim Shahzad, Date : 11th May 2023, Tracking ID : VP-NAP-202302021 / VC-NAP-202302021
        this.setInternationaltxnfailedfee(cmsWsEntity.getInternationaltxnfailedfee());
        // =====================================================================================
        ...
        this.setInternationaltxnfailedfeepercent(cmsWsEntity.getInternationaltxnfailedfeepercent());
        this.setInternationaltxnfailedfeepercenttax(cmsWsEntity.getInternationaltxnfailedfeepercenttax());
        this.setInternationaltxnfeepercent(cmsWsEntity.getInternationaltxnfeepercent());
        this.setInternationaltxnfeepercenttax(cmsWsEntity.getInternationaltxnfeepercenttax());
        // =====================================================================================
        ...
        this.setCustomPaymentService(cmsWsEntity.getCustomPaymentService());
    ...
    // Asim Shahzad, Date : 1st Feb 2023, Tracking ID : VP-NAP-202302021 / VC-NAP-202302021
    ...
    public void setInternationaltxnfeepercent(String intltxnfeepercent) {
        this.internationaltxnfeepercent = intltxnfeepercent;
    }
    ...
    public void setInternationaltxnfeepercenttax(String intltxnfeepercenttax) {
        this.internationaltxnfeepercenttax = intltxnfeepercenttax;
    }
