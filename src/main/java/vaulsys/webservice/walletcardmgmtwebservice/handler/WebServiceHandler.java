...
//    }
    ...
    public static WalletCMSWsEntity processTransactionNotFoundReversal(WalletCMSWsEntity wsmodel)
    {
        return WSOperation.ExecuteTransactionNotFoundReversal(wsmodel);
    }
    // =======================================================================================================

    // Asim Shahzad, Date : 9th Sep 2022, Tracking ID : NAP-R4-22
    public static WalletCMSWsEntity processVISARefundTransaction(WalletCMSWsEntity wsmodel)
    {
        return WSOperation.ExecuteVISARefundTransaction(wsmodel);
    }
    // ==========================================================

    // Asim Shahzad, Date : 5th Feb 2023, Tracking ID : VP-NAP-202302021 / VC-NAP-202302021
    public static WalletCMSWsEntity processChargeCustomerTransaction(WalletCMSWsEntity wsmodel)
    {
        return WSOperation.ExecuteChargeCustomerTransaction(wsmodel);
    }
    // ====================================================================================
